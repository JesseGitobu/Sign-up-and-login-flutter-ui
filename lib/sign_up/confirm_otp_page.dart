...
import 'package:signup_ui_backend/sign_up/introduction_page.dart';
    ...
    Widget background = Container(
      decoration: BoxDecoration(
        image: DecorationImage(
            image: AssetImage('assets/backfour.jpg'), fit: BoxFit.cover),
      ),
      foregroundDecoration: BoxDecoration(color: Colors.black26.withOpacity(0.3)),
    );
